...
export const tileAssets = {
  ...
  grass_3: new URL('./public/assets/tiles/grass_3.png', import.meta.url).href,
  grass_4: new URL('./public/assets/tiles/grass_4.png', import.meta.url).href,
  grass_5: new URL('./public/assets/tiles/grass_5.png', import.meta.url).href,
