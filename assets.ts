...
export const tileAssets = {
  ...
  wooden_wall_poor: new URL('./public/assets-optimized/tiles/wooden_wall_poor.png', import.meta.url).href,
  wooden_wall: new URL('./public/assets-optimized/tiles/wooden_wall.png', import.meta.url).href,
  wooden_wall_posh: new URL('./public/assets-optimized/tiles/wooden_wall_posh.png', import.meta.url).href,
  ...
  tuft_01: new URL('./public/assets-optimized/tiles/tuft/tuft_01.png', import.meta.url).href,
  tuft_02: new URL('./public/assets-optimized/tiles/tuft/tuft_02.png', import.meta.url).href,
