...
export const tileAssets = {
  ...
  crate: '/TwilightGame/assets-optimized/tiles/crate.png',
  rock_wall: '/TwilightGame/assets-optimized/tiles/rock_wall.png',
  ...
  sakura_tree_autumn: '/TwilightGame/assets-optimized/tiles/sakura_tree_autumn.png',
  sakura_tree_winter: '/TwilightGame/assets-optimized/tiles/sakura_tree_winter.png',
  ...
  cottage_medium_spring: '/TwilightGame/assets-optimized/tiles/cottage_medium_spring.png',
  ...
  home_autumn: '/TwilightGame/assets-optimized/tiles/home_autumn.png',
  home_winter: '/TwilightGame/assets-optimized/tiles/home_winter.png',
  ...
  chest: '/TwilightGame/assets-optimized/items/furniture/chest.png',
...
export const farmingAssets = {
  ...
  // Magic bean reuses the pea's young-stage art; only the adult stalk has unique art
  plant_magic_bean_young: '/TwilightGame/assets-optimized/farming/plant_pea_young.png',
  plant_magic_bean_adult: '/TwilightGame/assets-optimized/farming/plant_magic_bean_adult.png',
  ...
  plant_cauliflower_young: '/TwilightGame/assets-optimized/farming/cauliflower_young.png',
  plant_cauliflower_adult: '/TwilightGame/assets-optimized/farming/cauliflower_adult.png',
...
export const cookingAssets = {
  ...
  corn_bread: '/TwilightGame/assets-optimized/cooking/corn_bread.png',
  corn_flour: '/TwilightGame/assets-optimized/cooking/corn_flour.png',
  ...
  garden_salad: '/TwilightGame/assets-optimized/cooking/garden_salad.png',
  ice_cream: '/TwilightGame/assets-optimized/cooking/ice_cream.png',
  marzipan_chocolates: '/TwilightGame/assets-optimized/cooking/marzipan_chocolates.png',
  melon_granita: '/TwilightGame/assets-optimized/cooking/melon_granita.png',
  ...
  pumpkin_pie: '/TwilightGame/assets-optimized/cooking/pumpkin_pie.png',
...
export const groceryAssets = {
  ...
  cucumber_crop: '/TwilightGame/assets-optimized/items/grocery/cucumber_crop.png',
  ...
  lemon: '/TwilightGame/assets-optimized/items/grocery/lemon.png',
  meat: '/TwilightGame/assets-optimized/items/grocery/meat.png',
  melon_crop: '/TwilightGame/assets-optimized/items/grocery/melon_crop.png',
  ...
  cauliflower_crop: '/TwilightGame/assets-optimized/items/grocery/cauliflower_crop.png',
...
export const npcAssets = {
  ...
  // Mordecai's time bubble and freed wizard form (Wizard Trials epilogue — walkable NPC)
  wizard_timebubble: '/TwilightGame/assets-optimized/npcs/mordecai/wizard_timebubble.png',
  wizard_mordecai: '/TwilightGame/assets-optimized/npcs/mordecai/wizard_mordecai.png',
...
export const itemAssets = {
  ...
  cauliflower_seeds: '/TwilightGame/assets-optimized/items/cauliflower_seeds.png',
  ...
  magic_bean_seeds: '/TwilightGame/assets-optimized/farming/magic_bean_seed.png',
...
export const audioAssets: Record<string, AudioAssetConfig> = {
  ...
  music_village_summer: {
    url: '/TwilightGame/assets/audio/music/summer_atmo.mp3',
    category: 'music',
    loop: true,
  },
