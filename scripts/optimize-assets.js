...
async function optimizeTiles() {
  ...
  for (const inputPath of allFiles) {
    ...
    else if (file.includes('shop') || file.includes('cottage') || file.includes('mine_entrance') || file.includes('garden_shed') || file.includes('greenhouse') || file.includes('mushroom_house') || file.includes('ruins_entrance') || file.includes('bear_cave') || file.includes('entrance_wizard_trials')) {
      await sharp(inputPath)
