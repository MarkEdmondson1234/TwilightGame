...
export const SPRITE_METADATA: SpriteMetadata[] = [
  ...
  {
    tileType: TileType.SHRINKING_VIOLET,
    spriteWidth: 1, // 1 tile wide (small wildflower)
    spriteHeight: 1, // 1 tile tall (square image)
    offsetX: 0, // No offset needed for 1x1
    offsetY: 0, // No offset needed for 1x1
    image: tileAssets.shrinking_violet,
    // Collision: walkable (no collision) - forageable plant
    collisionWidth: 0,
    collisionHeight: 0,
    collisionOffsetX: 0,
  ...
  },
  {
    ...
    enableScale: false,
    enableBrightness: false,
    // Ground footprint only: the player can walk behind the tall painted column.
    collisionWidth: 0.65,
    collisionHeight: 0.24,
    collisionOffsetX: 0.7,
    collisionOffsetY: 1.44,
  },
  {
    ...
    collisionWidth: 1.6,
    collisionHeight: 0.5,
    collisionOffsetX: 1.75,
    collisionOffsetY: 3.75,
  },
  {
  ...
  },
  {
    ...
    collisionOffsetX: 0.325,
    collisionOffsetY: 0.325,
  },
  {
    ...
    collisionOffsetX: 0.875,
    collisionOffsetY: 0.875,
  },
  {
    ...
    collisionWidth: 5.4,
    collisionHeight: 5.4,
    collisionOffsetX: 1.3,
    collisionOffsetY: 1.3,
  },
  {
    ...
    collisionWidth: 0.9,
    collisionHeight: 0.3,
    collisionOffsetX: 0.55,
    collisionOffsetY: 1.35,
  },
  {
  ...
  },
  {
    ...
    enableBrightness: false,
    collisionWidth: 2,
    collisionHeight: 0.66,
    collisionOffsetX: 2,
    collisionOffsetY: 4.26,
  },
  {
