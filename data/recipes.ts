...
export const RECIPES: Record<string, RecipeDefinition> = {
  ...
  garden_salad: {
    ...
    category: 'miscellaneous',
    description: "A simple, fresh salad — about the only thing Mr Fox can make.",
    ingredients: [
      { itemId: 'crop_salad', quantity: 1 },
      { itemId: 'crop_tomato', quantity: 1 },
      { itemId: 'crop_cucumber', quantity: 1 },
      { itemId: 'crop_pea', quantity: 1 },
      { itemId: 'olive_oil', quantity: 1 },
      { itemId: 'vinegar', quantity: 1 },
      { itemId: 'salt', quantity: 1 },
      { itemId: 'pepper', quantity: 1 },
    ...
    cookingTime: 15,
    difficulty: 1,
    resultItemId: 'food_garden_salad',
    resultQuantity: 1,
    friendshipValue: 15,
    teacherNpc: 'shopkeeper',
    image: cookingAssets.garden_salad,
    instructions: [
      'Wash all the vegetables thoroughly and dry them.',
      'Cut the tomatoes into boats, the cucumber into squares and shred the salad.',
      'Mix vinegar and oil, and add salt and pepper to taste.',
  ...
  corn_flour: {
    ...
    category: 'miscellaneous',
    description: 'Home-ground corn flour — simple, but useful all through the harvest season.',
    ingredients: [
      { itemId: 'crop_corn', quantity: 3 },
    ],
    cookingTime: 10,
    difficulty: 1,
    resultItemId: 'corn_flour',
    resultQuantity: 1,
    friendshipValue: 10,
    image: cookingAssets.corn_flour,
    instructions: [
      'Make sure the kernels are completely dry.',
      'Blend until the texture is powdery.',
      'Filter out larger pieces.',
  ...
  corn_bread: {
    ...
    category: 'miscellaneous',
    description: 'Warm, slightly sweet corn bread, best eaten fresh from the tin.',
    ingredients: [
      { itemId: 'corn_flour', quantity: 2 },
      { itemId: 'flour', quantity: 1 },
      { itemId: 'milk', quantity: 1 },
      { itemId: 'egg', quantity: 1 },
      { itemId: 'butter', quantity: 1 },
    ...
    cookingTime: 25,
    difficulty: 2,
    resultItemId: 'food_corn_bread',
    resultQuantity: 2,
    friendshipValue: 20,
    image: cookingAssets.corn_bread,
    instructions: [
      'Mix the corn flour, flour, baking powder and salt in a bowl.',
      'In another bowl, whisk together the egg, milk, melted butter and sugar.',
      "Combine the two mixtures until just smooth — don't overmix.",
      'Pour into a greased tin and bake at 200 degrees Celsius for 20-25 minutes, until golden and a skewer comes out clean.',
    ],
  },
  ...
  pumpkin_pie: {
    ...
    category: 'miscellaneous',
    description: 'A proper harvest treat — nothing says autumn quite like it.',
    ingredients: [
      ...
      { itemId: 'milk', quantity: 1 },
      { itemId: 'cinnamon', quantity: 1 },
      { itemId: 'allspice', quantity: 1 },
    ],
    cookingTime: 65,
    difficulty: 3,
    resultItemId: 'food_pumpkin_pie',
    resultQuantity: 1,
    friendshipValue: 45,
    image: cookingAssets.pumpkin_pie,
    instructions: [
      'Turn the pumpkin into mash, then add milk, sugar and the spices.',
      'In another bowl, mix the flour with sugar, salt and butter. Use the egg to make it come together into a dough.',
      'With a rolling pin, flatten the dough and line a cake tray. Pre-bake for 15 minutes in the oven at 175 degrees Celsius.',
      'Add the pumpkin filling, and bake the pie for 50 minutes. Serve with cold cream and maple syrup.',
    ],
  },
  ...
  melon_granita: {
    ...
    category: 'miscellaneous',
    description: "A refreshing frozen melon dessert — Spring Periwinkle's favourite.",
    ingredients: [
      { itemId: 'crop_melon', quantity: 1 },
      { itemId: 'sugar', quantity: 1 },
      { itemId: 'water', quantity: 1 },
    ...
    cookingTime: 30,
    difficulty: 2,
    resultItemId: 'food_melon_granita',
    resultQuantity: 1,
    friendshipValue: 30,
    teacherNpc: 'spring_periwinkle',
    image: cookingAssets.melon_granita,
    instructions: [
      'Blend the melon.',
      'Add water, sugar and lemon juice to taste.',
      'Freeze the mixture in a low metal tray, scraping the edges with a fork every hour.',
      "When the mixture looks like a pile of melon-coloured snow, it's done.",
    ],
  },
