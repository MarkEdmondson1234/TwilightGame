...
- The opening field gives warning time, and spawns preserve a free lane in each nearby depth band. The first roughly seven seconds stay gentle, then speed rises continuously with distance, including beyond depth 30. Obstacle intervals shrink to about 440 ms by depth 3 (minimum 300 ms). Snow-covered dead spruces, small spruces, and hazel bushes from the winter forest artwork mix into the static obstacles, with individually measured ground padding and collision widths. Deer appear from depth 2 walking slowly across the trail at 100 world units/second, facing their direction with the existing three-frame walking animation. Their crossing is fixed, not aimed at the skier. Contact follows their moving body and the warning predicts their crossing position; pausing also freezes their walk. Wolves appear from depth 4. Nearby wolves mark a 0.55-second wind-up, lock your position, then leap sideways over 0.55 seconds. Boosting can pass before their landing; dodging after they commit also works. Poor, medium and fine logs appear from depths 1, 3 and 5.
