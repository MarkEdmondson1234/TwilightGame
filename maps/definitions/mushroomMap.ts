...
LGGGGuGPGuGG7eeGGeGGeGGPG¤GtGL
LLLLLLLLLLLLL¤LLeLLLLLLLLLLLLL
`;
...
export const mushroomMap: MapDefinition = {
  ...
  npcs: [
    ...
    // Davead - French expat flamingo, hidden in the shade of the willow at (7,10)
    createDaveadNPC('davead', { x: 7, y: 10 }),
  ],
};
