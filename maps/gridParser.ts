...
export const GRID_CODES: Record<string, TileType> = {
  ...
  J: TileType.SAKURA_TREE, // J = Sakura tree (seasonal)
  ...
  '6': TileType.DEAD_SPRUCE, // 6 = Dead spruce/fir tree (barren dead tree, mushroom forest)
  ...
  z: TileType.GREENHOUSE, // z = greenZ-house (glass greenhouse — grow any crop all year)
