/**
 * PaintingEaselUI - Freehand drawing overlay with layers, opacity, and eyedropper
 *
...
const PaintingEaselUI: React.FC<PaintingEaselUIProps> = ({ isOpen, onClose }) => {
  ...
  const [selectedScale, setSelectedScale] = useState(1.5); // Character-relative scale (default Large)
  ...
  const handleCanvasClick = useCallback(
    (e: React.MouseEvent<HTMLDivElement>) => {
      ...
      // Scale click coordinates to canvas buffer coordinates
